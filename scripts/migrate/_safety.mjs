// Shared safety rails for the Phase 2 band-migration scripts (Birdhaus side).
//
...
export async function confirmTarget({ scriptName, mode }) {
  ...
  console.log(`Target: ${maskTarget(url)}  (Birdhaus / DATABASE_URL)`);
...
export function connect(url) {
  return postgres(url, { ssl: sslOptionFor(url) });
}
